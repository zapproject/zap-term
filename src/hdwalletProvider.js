...
HDWalletProvider.prototype.on = function (type, callback) {
    return this.subscriptionProvider.on(type, callback);
};


// HDWalletProvider.prototype.removeListener = function (type, callback) {
